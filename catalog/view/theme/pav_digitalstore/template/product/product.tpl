   ...
   <?php if ($profiles): ?>
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <label><?php echo $option['name']; ?>:</label>
          <input class="button btn btn-theme-primary" type="button" value="<?php echo $button_upload; ?>" id="button-option-<?php echo $option['product_option_id']; ?>">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <label><?php echo $option['name']; ?>:</label>
          <input class="date form-control" type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>">
        </div>
        <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <label><?php echo $option['name']; ?>:</label>
          <input class="time form-control" type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>">
        </div>
        <?php } ?>
        <?php } ?>
      </div>
    ...
    <div class="box-content products-block carousel-inner clearfix ">
      ...
      <div class="image">
        ...
        <?php if( $categoryPzoom ) { $zimage = str_replace( "cache/","", preg_replace("#-\d+x\d+#", "",  $product['thumb'] ));  ?>
          <a href="<?php echo $zimage;?>" class="related-colorbox product-zoom hidden-sm hidden-xs" rel="nofollow" title="<?php echo $product['name']; ?>"><span class="fa fa-search-plus"></span></a>
          <?php } ?>
        <?php //#2 Start fix quickview in fw?>
          <?php if ($quickview) { ?>
          <a class="pav-colorbox hidden-sm hidden-xs" href="<?php echo $this->url->link("themecontrol/product",'product_id='.$product['product_id'] );?>"><span class='fa fa-eye'></span><?php echo $this->language->get('quick_view'); ?></a>
          <?php } ?>
